...
func loggerFromContext(c *gin.Context) *pkglogger.Logger {
	...
	return pkglogger.New("catalog-service", "development", "info")
}
...
func CORS() gin.HandlerFunc {
	...
	return func(c *gin.Context) {
		...
		c.Header("Access-Control-Allow-Headers", "Authorization, Content-Type, X-Request-ID, X-User-ID, X-User-Role")
