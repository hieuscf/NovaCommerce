...
- **Layout:** `AdminShell` — dark navy sidebar (`slate-950`) + sticky topbar (search, notifications, theme toggle, language, admin profile), mobile sheet nav, console footer
