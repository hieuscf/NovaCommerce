...
| Admin (Next.js) | 🚧 | `apps/admin` — Alloy dashboard + Account/Seller Management + Seller Approval drawer fixtures, dark sidebar + topbar, isolated session/API client, error boundaries, Vitest |
