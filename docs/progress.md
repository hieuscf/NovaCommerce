...
| Admin (Next.js) | 🚧 | `apps/admin` — Alloy dashboard + Product list/detail (view/edit/lock) + Account/Seller Management + Seller Approval fixtures, dark sidebar + topbar, isolated session/API client, error boundaries, Vitest |
