...
| Admin (Next.js) | 🚧 | `apps/admin` — Alloy dashboard + Product/Account/Seller Management + Seller Approval fixtures, dark sidebar + topbar, isolated session/API client, error boundaries, Vitest |
